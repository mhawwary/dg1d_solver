...
void PostProcess(){
    ...
    double L1_average_sol_=0.0,L1_proj_sol_=0.0;
    double L2_average_sol_=0.0,L2_proj_sol_=0.0;

    dg_solver_.Compute_vertex_sol();
    L1_proj_sol_ = dg_solver_.L1_error_projected_sol();
    L1_average_sol_= dg_solver_.L1_error_average_sol();
    L2_proj_sol_ = dg_solver_.L2_error_projected_sol();
    L2_average_sol_= dg_solver_.L2_error_average_sol();

    dg_solver_.print_cont_vertex_sol();
    dg_solver_.print_average_sol();
    dg_solver_.dump_discont_sol();
    dg_solver_.dump_errors(L1_proj_sol_,L1_average_sol_
                           ,L2_proj_sol_,L2_average_sol_);
